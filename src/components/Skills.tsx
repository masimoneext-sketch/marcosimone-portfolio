...
const skillCategories: SkillCategory[] = [
  {
    ...
    icon: '🤖',
    skills: [
      { name: 'Claude AI / Anthropic', level: 94 },
      { name: 'Prompt Engineering', level: 92 },
      { name: 'AI Integration (Claude + Groq)', level: 90 },
      { name: 'AI-Augmented Development', level: 92 },
      { name: 'Multi-Agent Orchestration', level: 90 },
      { name: 'Knowledge Base Engine (TF-IDF)', level: 88 },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Linux (Ubuntu)', level: 84 },
      { name: 'Traefik (multi-layer TLS)', level: 82 },
      { name: 'Nginx', level: 80 },
      { name: 'PM2', level: 88 },
      { name: 'VPS Management (dev/stage/prod)', level: 88 },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: 'Chrome Extensions (Manifest V3)', level: 70 },
      { name: 'React Native / Expo', level: 70 },
      { name: 'MySQL / SQLite', level: 72 },
      { name: 'REST API + JWT Auth', level: 75 },
      { name: 'Laravel / PHP', level: 55 },
    ],
  },
]
